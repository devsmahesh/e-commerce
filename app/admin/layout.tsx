...
import { LayoutDashboard, Package, ShoppingBag, Users, Tag, Image as ImageIcon, FolderTree, LogOut, Menu, X, ChevronLeft, ChevronRight, MessageSquare, Zap } from 'lucide-react'
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: ROUTES.ADMIN.FLASH_DEALS, label: 'Flash Deals', icon: Zap },
