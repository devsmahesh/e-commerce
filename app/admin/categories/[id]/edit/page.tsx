...
import { useUpdateCategoryMutation, useGetCategoryByIdQuery, useUploadCategoryImageMutation } from '@/store/api/categoriesApi'
          ...
          <Form>
            ...
            <div className="flex justify-end gap-4 pt-6">
              ...
              <Button type="submit" disabled={isLoading || isSubmitting || isUploading}>
                {isLoading || isSubmitting || isUploading ? 'Updating...' : 'Update Category'}
              </Button>
            </div>
          </Form>
        )}
